...
- [Importador de Transações por arquivo - Teste Técnico S2](#importador-de-transações-por-arquivo---teste-técnico-s2)
  ...
  - [2. Diagrama de entidades e relacionamentos COLOCAR DIAGRAMA](#2-diagrama-de-entidades-e-relacionamentos-colocar-diagrama)
  - [3. Preparativos](#3-preparativos)
    ...
    - [3.5. Rodando a API localmente](#35-rodando-a-api-localmente)
  - [4. Rotas](#4-rotas)
  ...
  - [5. Histórico de desenvolvimento](#5-histórico-de-desenvolvimento)
    ...
    - [4.2. Decisões de desenvolvimento](#42-decisões-de-desenvolvimento)
      ...
      - [4.2.2. Models, Serializers e View](#422-models-serializers-e-view)
      - [4.2.3. Utils e Media](#423-utils-e-media)
    - [4.2.4. Configurações extras](#424-configurações-extras)
      - [4.2.4.1 Configurar para que apenas super usuários possam importar arquivos](#4241-configurar-para-que-apenas-super-usuários-possam-importar-arquivos)
...
## 2. Diagrama de entidades e relacionamentos COLOCAR DIAGRAMA
...
http://localhost:8000/api/user/23270298056/ -> 23270298056 CPF do usuário José da Costa
...
#### 4.2.2. Models, Serializers e View
...
### 4.2.4. Configurações extras

#### 4.2.4.1 Configurar para que apenas super usuários possam importar arquivos
